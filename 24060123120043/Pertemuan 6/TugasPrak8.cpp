...
void draw(int isShadow) {
    ...
    gluCylinder(quadric, 5.0, 5.0, 15.0, 20, 20);
    glPopMatrix();

    // --- Daun bawah ---
    glPushMatrix();
    glTranslatef(0.0f, 0.0f, 15.0f);
    if (!isShadow) glColor3f(0.0f, 0.5f, 0.0f);
    gluCylinder(quadric, 20.0, 0.0, 20.0, 20, 20);
    glPopMatrix();

    // --- Daun tengah ---
    glPushMatrix();
    glTranslatef(0.0f, 0.0f, 30.0f);
    if (!isShadow) glColor3f(0.0f, 0.6f, 0.0f);
    gluCylinder(quadric, 15.0, 0.0, 20.0, 20, 20);
    glPopMatrix();

    // --- Daun atas ---
    glPushMatrix();
    glTranslatef(0.0f, 0.0f, 45.0f);
    if (!isShadow) glColor3f(0.0f, 0.7f, 0.0f);
    gluCylinder(quadric, 10.0, 0.0, 20.0, 20, 20);
    glPopMatrix();
