...
void drawBox() {
    ...
    glPushMatrix();
    glTranslatef(0.0f, legHeight / 2.0f + topHeight / 2.0f + 0.5f, 0.0f);
    glBegin(GL_QUADS);
        // TOP
        glVertex3f(-topWidth / 2, topHeight / 2, -topDepth / 2);
        glVertex3f(topWidth / 2, topHeight / 2, -topDepth / 2);
        glVertex3f(topWidth / 2, topHeight / 2, topDepth / 2);
        glVertex3f(-topWidth / 2, topHeight / 2, topDepth / 2);
    ...
    // ========== KAKI-KAKI MEJA ==========
    float legX = topWidth / 2 - legThickness / 2;
    float legZ = topDepth / 2 - legThickness / 2;

    glColor3f(0.3f, 0.15f, 0.05f); // warna kaki

    for (int i = -1; i <= 1; i += 2) {
        for (int j = -1; j <= 1; j += 2) {
            float cx = i * legX;
            float cz = j * legZ;
            float cy = legHeight / 2.0f;
            ...
            glBegin(GL_QUADS);
                // TOP
                glVertex3f(-legThickness / 2, legHeight / 2, -legThickness / 2);
                glVertex3f(legThickness / 2, legHeight / 2, -legThickness / 2);
                glVertex3f(legThickness / 2, legHeight / 2, legThickness / 2);
                glVertex3f(-legThickness / 2, legHeight / 2, legThickness / 2);
